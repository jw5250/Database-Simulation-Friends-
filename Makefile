#
# Created by gmakemake (Ubuntu Jul 25 2014) on Wed Nov 22 22:20:39 2023
#
...
CPP_FILES =	
C_FILES =	HashADT.c amici.c array.c command.c user.c
PS_FILES =	
S_FILES =	
H_FILES =	HashADT.h amici.h array.h command.h user.h
SOURCEFILES =	$(H_FILES) $(CPP_FILES) $(C_FILES) $(S_FILES)
.PRECIOUS:	$(SOURCEFILES)
OBJFILES =	HashADT.o array.o command.o user.o 
...
HashADT.o:	HashADT.h
amici.o:	HashADT.h array.h command.h user.h
array.o:	array.h
command.o:	array.h command.h
user.o:	array.h user.h
